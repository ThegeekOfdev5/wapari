<div x-data="{ showMobileFilter: false }">
    <div class="border-b border-slate-200">
        <nav
            ...
            class="px-4 mx-auto overflow-hidden max-w-7xl whitespace-nowrap sm:px-6 lg:px-8"
        >
            <ol
                role="list"
    ...
    <main class="max-w-2xl px-4 mx-auto lg:max-w-7xl lg:px-8">
        <div class="flex items-baseline justify-between pt-8 pb-6 border-b border-gray-200">
                ...
                <x-dropdown>
                    <x-slot:trigger>
                        ...
                        >
                            ...
                            <x-heroicon-m-chevron-down class="flex-shrink-0 w-5 h-5 ml-1 -mr-1 text-gray-400 group-hover:text-gray-500" />
                        </button>
                    </x-slot:trigger>
                    <x-slot:content>
                        <x-dropdown-link
            ...
            @else
                <aside>
                    ...
                    >
                        ...
                        <x-heroicon-m-plus class="flex-shrink-0 w-5 h-5 ml-1 text-slate-400" />
                    </button>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            @if($value->option->visual == 'color')
                                                                <span
                                                                    class="inline-flex items-center justify-center w-full h-full duration-150 bg-center bg-cover rounded-full shadow cursor-pointer"
                                                            ...
                                                            @else
                                                                ...
                                                                ></span>
                                                            @endif
                                                            <x-heroicon-m-check class="absolute inset-0 z-0 hidden w-5 h-5 m-auto text-white duration-150 pointer-events-none peer-checked:block" />
                                                        </label>
                                                    </div>
                                                @else
                                                    <div class="flex items-center">
                                        ...
                                        @foreach($product->options as $option)
                                            @if($option->visual === 'color')
                                                @foreach($option->optionValues->take(5) as $optionValue)
                                                    <li
                                                        class="w-4 h-4 border border-black rounded-full border-opacity-10"
