<div>
    <div class="max-w-2xl px-4 pt-8 pb-24 mx-auto sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 mt-4 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="shippingAddress.name" type="text" id="shipping-name"
                                    name="shipping-name" autocomplete="given-name" class="block w-full sm:text-sm" />
                            </div>
                        ...
                        {{-- <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="shippingAddress.company_name" type="text"
                                    name="shipping-company" id="shipping-company" class="block w-full sm:text-sm" />
                            </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="shippingAddress.address_line_1" type="text"
                                    name="shipping-address-line-1" id="shipping-address-line-1"
                        ...
                        {{-- <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="shippingAddress.address_line_2" type="text"
                                    name="shipping-address-line-2" id="shipping-address-line-2"
                        ...
                        {{-- <div>
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="shippingAddress.city" type="text" name="shipping-city"
                                    id="shipping-city" autocomplete="address-level2" class="block w-full sm:text-sm" />
                            </div>
                            <x-input-error for="shippingAddress.city" class="mt-2" />
                        </div> --}}

                        <div>
                            <x-input-label for="shipping-country" class="block text-sm font-medium text-slate-700"
                                :value="__('Country')" />
                            <div class="mt-1">
                                <x-select wire:model.defer="shippingAddress.country_id"
                                    wire:change.prevent="updateShippingCountry($event.target.value)"
                                    id="shipping-country" name="shipping-country" autocomplete="country-name"
                                    class="block w-full sm:text-sm">
                        ...
                        {{-- <div>
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="shippingAddress.state" type="text" name="shipping-region"
                                    id="shipping-region" class="block w-full sm:text-sm" />
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="shippingAddress.postcode" type="text"
                                    name="shipping-postal-code" id="shipping-postal-code"
                                    class="block w-full sm:text-sm" />
                            </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="shipping_phone" type="text" name="shipping-phone"
                                    id="shipping-phone" class="block w-full sm:text-sm" />
                            </div>
                    ...
                    <fieldset>
                        ...
                        <div class="grid grid-cols-1 mt-4 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                            ...
                            <label @class(['relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm
                                focus:outline-none', 'border-transparent ring-2 ring-sky-600'=> $shippingRate->id ==
                                $shippingMethod, 'border-slate-300' => $shippingRate->id != $shippingMethod])>
                                <input wire:model="shippingMethod" type="radio" name="delivery-method"
                                    value="{{ $shippingRate->id }}" class="sr-only"
                                ...
                                <span class="flex flex-1">
                                    <span class="flex flex-col">
                                        <span id="delivery-method-{{ $shippingRate->id }}-label"
                                            class="block text-sm font-medium text-slate-900">
                                            {{ $shippingRate->name }}
                                        </span>
                                        <span id="delivery-method-{{ $shippingRate->id }}-description-0"
                                            class="flex items-center mt-1 text-sm text-slate-500">
                                            {{ $shippingRate->description }}
                                        </span>
                                        <span id="delivery-method-{{ $shippingRate->id }}-description-1"
                                            class="mt-6 text-sm font-medium text-slate-900">
                                            <x-money :amount="$shippingRate->price"
                                                :currency="config('app.currency')" />
                                        </span>
                                    </span>
                                </span>
                                <x-heroicon-m-check-circle @class(['h-5 w-5 text-sky-600', 'hidden'=> $shippingRate->id
                                    != $shippingMethod])
                                    aria-hidden="true"
                                    />
                            </label>
                ...
                <div class="pt-10 mt-10 border-t border-slate-200">
                    ...
                    <div class="grid grid-cols-1 mt-4 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="billingAddress.name" type="text" id="billing-name"
                                    name="billing-name" autocomplete="given-name" class="block w-full sm:text-sm" />
                            </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="billingAddress.company_name" type="text"
                                    name="billing-company" id="billing-company" class="block w-full sm:text-sm" />
                            </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="billingAddress.address_line_1" type="text"
                                    name="billing-address-line-1" id="billing-address-line-1"
                                    autocomplete="street-address" class="block w-full sm:text-sm" />
                            </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="billingAddress.address_line_2" type="text"
                                    name="billing-address-line-2" id="billing-address-line-2"
                                    class="block w-full sm:text-sm" />
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="billingAddress.city" type="text" name="billing-city"
                                    id="billing-city" autocomplete="address-level2" class="block w-full sm:text-sm" />
                            </div>
                            <x-input-error for="billingAddress.city" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="billing-country" class="block text-sm font-medium text-slate-700"
                                :value="__('Country')" />
                            <div class="mt-1">
                                <x-select wire:model.defer="billingAddress.country_id"
                                    wire:change.prevent="updateBillingCountry($event.target.value)" id="billing-country"
                                    name="billing-country" autocomplete="country-name" class="block w-full sm:text-sm">
                                    <option value="">Please select</option>
                                    @foreach($this->availableShippingCountries as $country)
                                    <option value="{{ $country->country->id }}">
                                        {{ $country->country->name }}
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="billingAddress.state" type="text" name="billing-region"
                                    id="billing-region" class="block w-full sm:text-sm" />
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="billingAddress.postcode" type="text"
                                    name="billing-postal-code" id="billing-postal-code"
                                    class="block w-full sm:text-sm" />
                            </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <x-input wire:model.defer="billing_phone" type="text" name="billing-phone"
                                    id="billing-phone" class="block w-full sm:text-sm" />
                            </div>
                ...
                <div class="pt-10 mt-10 border-t border-slate-200">
                    ...
                    <fieldset class="mt-4">
                        ...
                        <div x-data="{ paymentMethod: @entangle('paymentMethod').defer }" class="space-y-4">
                            ...
                            <label
                                class="relative block px-6 py-4 bg-white border rounded-lg shadow-sm cursor-pointer focus:outline-none sm:flex sm:justify-between"
                                ...
                                <input x-model="paymentMethod" id="{{ $paymentProvider->identifier }}" type="radio"
                                    name="payment-method" value="{{ $paymentProvider->identifier }}" class="sr-only">
                        ...
                        <ul role="list" class="text-sm text-gray-900 divide-y divide-gray-200">
                            ...
                            <li class="flex items-center px-4 py-6 space-x-4 sm:px-6">
                                <div class="relative flex flex-shrink-0 border rounded-md border-slate-200">
                                    ...
                                    {{ $item->variant->getFirstMedia('image')('thumb_large')->attributes(['alt' =>
                                    $item->product->name, 'class' => 'h-20 w-20 rounded-md']) }}
                                    @elseif($item->product->hasMedia('gallery'))
                                    {{ $item->product->getFirstMedia('gallery')('thumb_large')->attributes(['alt' =>
                                    $item->product->name, 'class' => 'h-20 w-20 rounded-md']) }}
                                    @else
                                ...
                                <div class="flex-auto ml-6 space-y-1">
                                    ...
                                    <ul class="space-x-2 text-sm divide-x divide-slate-200 text-slate-500">
                                    ...
                                    <p class="text-sm text-slate-500">
                                        ...
                                        {{ $item->discount->code }}
                                        <x-money :amount="-$item->discountedAmount"
                                            :currency="config('app.currency')" />
                                    </p>
                                    @endif
                                </div>
                        ...
                        <dl class="px-4 py-6 space-y-6 border-t border-slate-200 sm:px-6">
                            ...
                            <div x-data="{ showDiscountForm: @entangle('showDiscountForm') }">
                                <div class="flex items-center justify-between">
                                    <dt class="text-sm">
                                        {{ __('Discount') }}
                                        <button x-on:click="showDiscountForm = !showDiscountForm" type="button"
                                            class="underline btn btn-link">
                                ...
                                <div class="mt-1">
                                    ...
                                    <x-badge>
                                        {{ $discount->code }}
                                        <button wire:click.prevent="removeDiscount('{{ $discount->code }}')"
                                            type="button"
                                    ...
                                    <div x-cloak x-show="showDiscountForm" x-trap="showDiscountForm">
                                        ...
                                        <div class="flex mt-2 space-x-4">
                                            <x-input x-on:keydown.enter.prevent="$wire.applyDiscount"
                                                wire:model.defer="discountCode" type="text" name="discount"
                                                id="discount" class="block w-full sm:text-sm"
                                                placeholder="{{ __('Discount code') }}" />
                                            <button wire:click.prevent="applyDiscount" type="button"
