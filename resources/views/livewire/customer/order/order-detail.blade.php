<div>
    ...
    <div class="bg-white">
        <div class="max-w-3xl px-4 py-3 mx-auto sm:px-6 sm:py-8 lg:px-8">
            <div>
                    ...
                    @foreach($order->orderItems as $item)
                        <li class="py-4 sm:py-6">
                            <div class="flex items-center sm:items-stretch">
                                <div class="relative flex-shrink-0 w-20 h-20 overflow-hidden border rounded-lg border-slate-200 bg-slate-200 sm:h-40 sm:w-40">
                            ...
                            @if($order->paymentMethod->identifier == 'stripe')
                                <div class="flex">
                                    <button
                                        ...
                                        type="button"
                                        class="block w-full btn btn-primary btn-lg"
                                    >
