                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <x-input wire:model.defer="state.store_name" type="text" id="storeNameInput"
                            class="block w-full mt-1 sm:text-sm" placeholder="{{ __('My Store') }}" />
                    ...
                    <div>
                        ...
                        <x-input wire:model.defer="state.store_slogan" type="text" id="storeSloganInput"
                            class="block w-full mt-1 sm:text-sm" placeholder="{{ __('Your store slogan') }}" />
                        <x-input-error for="state.store_slogan" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="storeEmailInput" :value="__('Store email address')" />
                        <x-input wire:model.defer="state.store_contact_email" type="email" id="storeEmailInput"
                            class="block w-full mt-1 sm:text-sm" placeholder="{{ __('contact@yourstore.tld') }}" />
                        <x-input-error for="state.store_contact_email" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="storeContactPhoneInput" :value="__('Contact phone number')" />
                        <x-input wire:model.defer="state.store_contact_phone" type="text" id="storeContactPhoneInput"
                            class="block w-full mt-1 sm:text-sm" placeholder="{{ __('+1 (555) 123-4567') }}" />
