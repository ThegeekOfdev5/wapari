        ...
        <form wire:submit.prevent="save" class="py-6 lg:flex-auto lg:py-0">
            <div class="space-y-12">
                    ...
                    <div class="grid grid-cols-1 mt-6 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div x-data="{ on: @entangle('stripe_payment_state.is_enabled').defer }" class="col-span-full">
                            <div class="flex items-center">
                                ...
                                <x-input-label x-on:click="on = !on; $refs.switch.focus()" :value="__('Enable')"
                                    class="ml-3" />
                            </div>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <x-input wire:model.defer="stripe_payment_state.display_name" type="text"
                                    id="stripeDisplayNameInput" class="block w-full sm:text-sm" />
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <x-textarea wire:model.defer="stripe_payment_state.description"
                                    id="stripePaymentDescriptionInput" class="block w-full sm:text-sm" />
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <x-textarea wire:model.defer="stripe_payment_state.meta.public_key"
                                    id="stripePaymentPublicKeyInput" class="block w-full sm:text-sm"
                                    placeholder="pk_..." />
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <x-textarea wire:model.defer="stripe_payment_state.meta.secret_key"
                                    id="stripePaymentSecretKeyInput" class="block w-full sm:text-sm"
                                    placeholder="sk_..." />
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <x-input wire:model.defer="stripe_payment_state.meta.webhook_secret"
                                    id="stripePaymentWebhookSecretInput" type="text" class="block w-full sm:text-sm"
                                    placeholder="whsec_..." />
                ...
                <div class="pb-12 border-b border-gray-900/10 dark:border-white/10">
                    ...
                    <div class="grid grid-cols-1 mt-6 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <x-input wire:model.defer="razorpay_payment_state.display_name" type="text"
                                    id="razorpayDisplayNameInput" class="block w-full sm:text-sm" />
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <x-textarea wire:model.defer="razorpay_payment_state.description"
                                    id="razorpayPaymentDescriptionInput" class="block w-full sm:text-sm" />
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                    {{ __('Displays to customers when they’re choosing a payment method.') }}
                                </p>
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <x-input wire:model.defer="razorpay_payment_state.meta.api_key"
                                    id="razorpayPaymentPublicKeyInput" type="text" class="block w-full sm:text-sm"
                                    placeholder="rzp_..." />
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <x-input wire:model.defer="razorpay_payment_state.meta.api_secret"
                                    id="razorpayPaymentSecretKeyInput" type="text" class="block w-full sm:text-sm" />
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <x-input wire:model.defer="razorpay_payment_state.meta.webhook_secret"
                                    id="razorpayPaymentWebhookSecretInput" type="text" class="block w-full sm:text-sm"
                                    placeholder="" />
                ...
                <div class="pb-12 border-b border-gray-900/10 dark:border-white/10">
                    ...
                    <div class="grid grid-cols-1 mt-6 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div x-data="{ on: @entangle('cash_on_delivery_state.is_enabled').defer }"
                            class="col-span-full">
                            <div class="flex items-center">
                                <button x-on:click="on = !on" x-ref="switch" type="button" role="switch"
                                    class="relative inline-flex flex-shrink-0 h-6 transition-colors duration-200 ease-in-out border-2 border-transparent rounded-full cursor-pointer w-11 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <x-input wire:model.defer="cash_on_delivery_state.display_name" type="text"
                                    id="cashOnDeliveryDisplayNameInput" class="block w-full sm:text-sm" />
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <x-textarea wire:model.defer="cash_on_delivery_state.description"
                                    id="cashOnDeliveryDescriptionInput" class="block w-full sm:text-sm" />
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                    {{ __('Displays to customers when they’re choosing a payment method.') }}
                                </p>
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <x-textarea wire:model.defer="cash_on_delivery_state.instructions"
                                    id="cashOnDeliveryInstructionsInput" class="block w-full sm:text-sm" />
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                ...
                <div class="pb-12 border-b border-gray-900/10 dark:border-white/10">
                    ...
                    <div class="grid grid-cols-1 mt-6 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <x-input wire:model.defer="bank_deposit_state.display_name" type="text"
                                    id="bankDepositDisplayNameInput" class="block w-full sm:text-sm" />
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <x-textarea wire:model.defer="bank_deposit_state.description"
                                    id="bankDepositDescriptionInput" class="block w-full sm:text-sm" />
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                    {{ __('Displays to customers when they’re choosing a payment method.') }}
                                </p>
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <x-textarea wire:model.defer="bank_deposit_state.instructions"
                                    id="bankDepositInstructionsInput" class="block w-full sm:text-sm" />
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                    {{ __('Displays to customers after they place an order with this payment method.')
                                    }}
                                </p>
