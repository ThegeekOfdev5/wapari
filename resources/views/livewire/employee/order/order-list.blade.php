                                    ...
                                    <tbody class="divide-y divide-slate-200 dark:divide-slate-200/10">
                                        @forelse($orders as $order)
                                            ...
                                            >
                                                ...
                                                <td class="relative px-3 py-4 text-sm font-medium text-left text-slate-900 whitespace-nowrap tabular-nums dark:text-slate-200">
                                                    <a
                                                ...
                                                <td class="relative px-3 py-4 text-sm text-left text-slate-900 whitespace-nowrap dark:text-slate-200">
                                                    @if($order->customer)
                                                        <a
                                                ...
                                                <td class="relative px-3 py-4 text-sm text-left text-slate-500 whitespace-nowrap dark:text-slate-400">
                                                ...
                                                <td class="relative px-3 py-4 text-sm text-left text-slate-500 whitespace-nowrap tabular-nums dark:text-slate-400">
                                                    {{ trans_choice(':count item|:count items', $order->order_items_sum_quantity) }}
                                                </td>
                                                <td class="relative px-3 py-4 text-sm text-right text-slate-500 whitespace-nowrap tabular-nums dark:text-slate-400">
                                                    <x-money :amount="$order->total" :currency="config('app.currency')"/>
                                                </td>
                                                <td class="py-4 pl-3 pr-4 text-sm text-right text-slate-500 whitespace-nowrap tabular-nums sm:pr-6 dark:text-slate-400">
                                                    {{ $order->created_at }}
                                                </td>
                                            </tr>
                                        @empty
