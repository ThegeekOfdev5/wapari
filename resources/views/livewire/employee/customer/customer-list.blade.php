        ...
        <x-card>
            <x-slot:content>
                <div class="max-w-lg mx-auto text-center">
                    <x-heroicon-o-user-group class="w-12 h-12 mx-auto text-slate-400" />
                    ...
                    <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                        {{ __('When you’ve added customers, you’ll be able to update their details, get a summary of
                        their order history and more.') }}
                    </p>
