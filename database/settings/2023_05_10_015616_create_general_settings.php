...
return new class extends SettingsMigration
{
    public function up(): void
    {
        ...
        $this->migrator->addEncrypted('general.license_key', '123456-7f23-456c-b456-123456789');
        $this->migrator->addEncrypted('general.license_user', 'K-shop');
        $this->migrator->add('general.license_vendor', 'K-shop Licence');
        $this->migrator->add('general.license_active', true);
